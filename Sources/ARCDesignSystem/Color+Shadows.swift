...
extension Color {
    ...
    public static let arcShadowLight = Color.black.opacity(0.08)
    ...
    public static let arcShadowMedium = Color.black.opacity(0.15)
    ...
    public static let arcShadowStrong = Color.black.opacity(0.25)
}
