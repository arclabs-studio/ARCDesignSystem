...
@Suite("Contrast Calculator Tests") struct ContrastCalculatorTests {
    // MARK: - Luminance Calculation

    @Test("Black has zero luminance") func blackHasZeroLuminance() {
    ...
    @Test("White has maximum luminance") func whiteHasMaximumLuminance() {
    ...
    @Test("Gray has intermediate luminance") func grayHasIntermediateLuminance() {
    ...
    @Test("Black on white has maximum contrast") func blackOnWhiteHasMaximumContrast() {
        let ratio = ARCContrastCalculator.contrastRatio(foreground: .black,
                                                        background: .white)
        #expect(ratio > 20.0 && ratio < 22.0, "Black on white should have ~21:1 contrast")
    }

    @Test("Same color has no contrast") func sameColorHasNoContrast() {
        let ratio = ARCContrastCalculator.contrastRatio(foreground: .red,
                                                        background: .red)
    ...
    @Test("Black text on white meets WCAG AA") func blackOnWhiteMeetsAA() {
        let passes = ARCContrastCalculator.meetsWCAG(foreground: .black,
                                                     background: .white,
                                                     level: .AA,
                                                     isLargeText: false)
    ...
    @Test("Black text on white meets WCAG AAA") func blackOnWhiteMeetsAAA() {
        let passes = ARCContrastCalculator.meetsWCAG(foreground: .black,
                                                     background: .white,
                                                     level: .AAA,
                                                     isLargeText: false)
    ...
    @Test("Large text has lower contrast requirements") func largeTextHasLowerRequirements() {
    ...
    @Test("Validation result includes all information") func validationResultIncludesAllInfo() {
        let result = ARCContrastCalculator.validate(foreground: .black,
                                                    background: .white,
                                                    isLargeText: false)
    ...
    @Test("UI components require 3:1 contrast") func uiComponentsRequireThreeToOne() {
        let constant = ARCContrastCalculator.wcagUIComponents
        #expect(constant == 3.0, "UI components should require 3:1 contrast")
    }

    @Test("Black meets UI component requirement on white") func blackMeetsUIComponentRequirement() {
        let passes = ARCContrastCalculator.meetsUIComponentRequirement(foreground: .black,
                                                                       background: .white)
        #expect(passes, "Black should meet UI component contrast on white")
    }
}

@Suite("Brand Color Contrast Tests") struct BrandColorContrastTests {
    // MARK: - Burgundy Contrast

    @Test("Burgundy on white meets AA for large text") func burgundyOnWhiteMeetsAALargeText() {
        ...
        let result = ARCContrastCalculator.validate(foreground: burgundy,
                                                    background: .white,
                                                    isLargeText: true)
    ...
    @Test("Burgundy meets UI component requirements") func burgundyMeetsUIComponentRequirements() {
        // Burgundy should work for buttons and interactive elements
        let burgundy = Color(red: 139 / 255, green: 38 / 255, blue: 53 / 255)
        let passes = ARCContrastCalculator.meetsUIComponentRequirement(foreground: burgundy,
                                                                       background: .white)
        #expect(passes, "Burgundy should meet 3:1 for UI components on white")
    }

    @Test("Burgundy dark variant works for white text") func burgundyDarkVariantWhiteText() {
        ...
        let result = ARCContrastCalculator.validate(foreground: .white,
    ...
    @Test("Gold does NOT meet AA for normal text on white") func goldDoesNotMeetAANormalTextOnWhite() {
        ...
        let result = ARCContrastCalculator.validate(foreground: gold,
                                                    background: .white,
                                                    isLargeText: false)
    ...
    @Test("Gold on dark background meets AA") func goldOnDarkBackgroundMeetsAA() {
    ...
    @Test("Gold meets UI component requirements on black") func goldMeetsUIComponentRequirementsOnBlack() {
        let gold = Color(red: 255 / 255, green: 180 / 255, blue: 46 / 255)
        let passes = ARCContrastCalculator.meetsUIComponentRequirement(foreground: gold,
                                                                       background: .black)
    ...
    @Test("White text on burgundy meets AA") func whiteOnBurgundyMeetsAA() {
        let burgundy = Color(red: 139 / 255, green: 38 / 255, blue: 53 / 255)
        let result = ARCContrastCalculator.validate(foreground: .white,
                                                    background: burgundy,
                                                    isLargeText: false)
    ...
    @Test("Black text on gold meets AA") func blackOnGoldMeetsAA() {
        let gold = Color(red: 255 / 255, green: 180 / 255, blue: 46 / 255)
        let result = ARCContrastCalculator.validate(foreground: .black,
                                                    background: gold,
                                                    isLargeText: false)
    ...
    @Test("High contrast burgundy has improved contrast") func highContrastBurgundyImproved() {
        ...
        let standardRatio = ARCContrastCalculator.contrastRatio(foreground: standardBurgundy,
                                                                background: .white)
        let highContrastRatio = ARCContrastCalculator.contrastRatio(foreground: highContrastBurgundy,
                                                                    background: .white)
...
@Suite("WCAG Constants Tests") struct WCAGConstantsTests {
    @Test("AA normal text requires 4.5:1") func aaNormalTextRequirement() {
        #expect(ARCContrastCalculator.wcagAANormalText == 4.5)
    }

    @Test("AA large text requires 3.0:1") func aaLargeTextRequirement() {
        #expect(ARCContrastCalculator.wcagAALargeText == 3.0)
    }

    @Test("AAA normal text requires 7.0:1") func aaaNormalTextRequirement() {
        #expect(ARCContrastCalculator.wcagAAANormalText == 7.0)
    }

    @Test("AAA large text requires 4.5:1") func aaaLargeTextRequirement() {
        #expect(ARCContrastCalculator.wcagAAALargeText == 4.5)
    }

    @Test("UI components require 3.0:1") func uiComponentsRequirement() {
