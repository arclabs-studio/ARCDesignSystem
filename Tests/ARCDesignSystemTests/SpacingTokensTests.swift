...
@Suite("Spacing Tokens Tests") struct SpacingTokensTests {
    @Test("XSmall spacing has correct value") func xSmallSpacingHasCorrectValue() {
        #expect(CGFloat.arcSpacingXSmall == 4, "XSmall spacing should be 4pt")
    }

    @Test("Small spacing has correct value") func smallSpacingHasCorrectValue() {
        #expect(CGFloat.arcSpacingSmall == 8, "Small spacing should be 8pt")
    }

    @Test("Medium spacing has correct value") func mediumSpacingHasCorrectValue() {
        #expect(CGFloat.arcSpacingMedium == 12, "Medium spacing should be 12pt")
    }

    @Test("Large spacing has correct value") func largeSpacingHasCorrectValue() {
        #expect(CGFloat.arcSpacingLarge == 16, "Large spacing should be 16pt")
    }

    @Test("XLarge spacing has correct value") func xLargeSpacingHasCorrectValue() {
        #expect(CGFloat.arcSpacingXLarge == 24, "XLarge spacing should be 24pt")
    }

    @Test("XXLarge spacing has correct value") func xxLargeSpacingHasCorrectValue() {
        #expect(CGFloat.arcSpacingXXLarge == 32, "XXLarge spacing should be 32pt")
    }

    @Test("Spacing tokens are in ascending order") func spacingTokensAreInAscendingOrder() {
    ...
    @Test("All spacing tokens are positive") func allSpacingTokensArePositive() {
